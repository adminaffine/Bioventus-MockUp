...
export default function PricingActionToast({ message, onDismiss }: Props) {
  return (
    <div className="fixed bottom-6 right-6 z-[1400] max-w-sm animate-in fade-in slide-in-from-bottom-2">
