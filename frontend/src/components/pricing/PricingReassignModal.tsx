...
import { PRICING_TEAM_OWNERS, type PricingTeamOwner } from "../../config/pricingTeamOwners";
...
type Props = {
  ...
  onClose: () => void;
  onConfirm: (owner: PricingTeamOwner) => Promise<void>;
};

export default function PricingReassignModal({
  open,
  issueId,
  recordLabel,
  currentOwnerId,
  ...
  const selected = PRICING_TEAM_OWNERS.find((o) => o.owner_id === selectedId);
