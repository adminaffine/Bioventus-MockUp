...
/** Display-only AI recommendations (no approve/reject — matches CFO issue detail). */
export default function CCOAiRecommendationPanel({ recommendations, className = "" }: Props) {
